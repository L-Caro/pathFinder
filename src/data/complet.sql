...
ALTER TABLE public.difficulty OWNER TO lionel;

--
-- Name: difficulty_id_seq; Type: SEQUENCE; Schema: public; Owner: lionel
--
...
ALTER TABLE public.difficulty_id_seq OWNER TO lionel;

--
-- Name: difficulty_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: lionel
--
...
--
-- Name: log_table; Type: TABLE; Schema: public; Owner: lionel
--
...
ALTER TABLE public.log_table OWNER TO lionel;

--
-- Name: log_table_id_seq; Type: SEQUENCE; Schema: public; Owner: lionel
--
...
ALTER TABLE public.log_table_id_seq OWNER TO lionel;

--
-- Name: log_table_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: lionel
--
...
--
-- Name: summit; Type: TABLE; Schema: public; Owner: lionel
--
...
ALTER TABLE public.summit OWNER TO lionel;

--
-- Name: summit_id_seq; Type: SEQUENCE; Schema: public; Owner: lionel
--
...
ALTER TABLE public.summit_id_seq OWNER TO lionel;

--
-- Name: summit_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: lionel
--
...
--
-- Name: tag; Type: TABLE; Schema: public; Owner: lionel
--
...
ALTER TABLE public.tag OWNER TO lionel;

--
-- Name: tag_has_trek; Type: TABLE; Schema: public; Owner: lionel
--
...
ALTER TABLE public.tag_has_trek OWNER TO lionel;

--
-- Name: tag_has_trek_id_seq; Type: SEQUENCE; Schema: public; Owner: lionel
--
...
ALTER TABLE public.tag_has_trek_id_seq OWNER TO lionel;

--
-- Name: tag_has_trek_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: lionel
--
...
--
-- Name: tag_id_seq; Type: SEQUENCE; Schema: public; Owner: lionel
--
...
ALTER TABLE public.tag_id_seq OWNER TO lionel;

--
-- Name: tag_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: lionel
--
...
--
-- Name: trek; Type: TABLE; Schema: public; Owner: lionel
--

CREATE TABLE public.trek (
    id integer NOT NULL,
    name character varying(100) NOT NULL,
    boucle character varying(50) NOT NULL,
    time_length character varying(50) NOT NULL,
    start_point character varying(100),
    gps_coordonate character varying(50),
    gpx character varying(100),
...
ALTER TABLE public.trek OWNER TO lionel;

--
-- Name: trek_id_seq; Type: SEQUENCE; Schema: public; Owner: lionel
--
...
ALTER TABLE public.trek_id_seq OWNER TO lionel;

--
-- Name: trek_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: lionel
--
...
--
-- Name: difficulty id; Type: DEFAULT; Schema: public; Owner: lionel
--
...
--
-- Name: log_table id; Type: DEFAULT; Schema: public; Owner: lionel
--
...
--
-- Name: summit id; Type: DEFAULT; Schema: public; Owner: lionel
--
...
--
-- Name: tag id; Type: DEFAULT; Schema: public; Owner: lionel
--
...
--
-- Name: tag_has_trek id; Type: DEFAULT; Schema: public; Owner: lionel
--
...
--
-- Name: trek id; Type: DEFAULT; Schema: public; Owner: lionel
--
...
--
-- Data for Name: difficulty; Type: TABLE DATA; Schema: public; Owner: lionel
--

INSERT INTO public.difficulty VALUES (1, 'Très facile', '2023-04-01 11:11:53.278619+02', NULL);
INSERT INTO public.difficulty VALUES (2, 'Facile', '2023-04-01 11:11:53.278619+02', NULL);
INSERT INTO public.difficulty VALUES (3, 'Modérée', '2023-04-01 11:11:53.278619+02', NULL);
INSERT INTO public.difficulty VALUES (4, 'Difficile', '2023-04-01 11:11:53.278619+02', NULL);
INSERT INTO public.difficulty VALUES (5, 'Très difficile', '2023-04-01 11:11:53.278619+02', NULL);


--
-- Name: difficulty_id_seq; Type: SEQUENCE SET; Schema: public; Owner: lionel
--
...
--
-- Data for Name: log_table; Type: TABLE DATA; Schema: public; Owner: lionel
--



--
-- Name: log_table_id_seq; Type: SEQUENCE SET; Schema: public; Owner: lionel
--
...
--
-- Data for Name: summit; Type: TABLE DATA; Schema: public; Owner: lionel
--

INSERT INTO public.summit VALUES (1, '2023-04-01 11:11:53.282551+02', NULL, 'Massif des Aiguilles Rouges');
INSERT INTO public.summit VALUES (2, '2023-04-01 11:11:53.282551+02', NULL, 'Massif des Aravis');
INSERT INTO public.summit VALUES (3, '2023-04-01 11:11:53.282551+02', NULL, 'Massif des Bornes');
INSERT INTO public.summit VALUES (4, '2023-04-01 11:11:53.282551+02', NULL, 'Massif des Bauges');
INSERT INTO public.summit VALUES (5, '2023-04-01 11:11:53.282551+02', NULL, 'Massif du Chablais');
INSERT INTO public.summit VALUES (6, '2023-04-01 11:11:53.282551+02', NULL, 'Massif des Fiz');
INSERT INTO public.summit VALUES (7, '2023-04-01 11:11:53.282551+02', NULL, 'Massif du Giffre');
INSERT INTO public.summit VALUES (8, '2023-04-01 11:11:53.282551+02', NULL, 'Massif du Mont Blanc');
INSERT INTO public.summit VALUES (9, '2023-04-01 11:11:53.282551+02', NULL, 'Massif du Salève');
INSERT INTO public.summit VALUES (10, '2023-04-01 11:11:53.282551+02', NULL, 'Massif des Voirons');


--
-- Name: summit_id_seq; Type: SEQUENCE SET; Schema: public; Owner: lionel
--
...
--
-- Data for Name: tag; Type: TABLE DATA; Schema: public; Owner: lionel
--

INSERT INTO public.tag VALUES (1, 'Lac', '2023-04-01 11:11:53.286377+02', NULL);
INSERT INTO public.tag VALUES (2, 'Neige', '2023-04-01 11:11:53.286377+02', NULL);
INSERT INTO public.tag VALUES (3, 'Cascade', '2023-04-01 11:11:53.286377+02', NULL);
INSERT INTO public.tag VALUES (4, 'Randonnée', '2023-04-01 11:11:53.286377+02', NULL);
INSERT INTO public.tag VALUES (5, 'Trail', '2023-04-01 11:11:53.286377+02', NULL);
INSERT INTO public.tag VALUES (6, 'Promenade', '2023-04-01 11:11:53.286377+02', NULL);
INSERT INTO public.tag VALUES (7, 'Bivouac', '2023-04-01 11:11:53.286377+02', NULL);
...
--
-- Data for Name: tag_has_trek; Type: TABLE DATA; Schema: public; Owner: lionel
--

INSERT INTO public.tag_has_trek VALUES (1, 4, 1, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (2, 4, 2, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (3, 2, 2, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (4, 10, 3, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (5, 2, 3, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (6, 4, 4, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (7, 2, 4, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (8, 10, 5, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (9, 2, 5, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (10, 4, 6, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (11, 4, 7, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (12, 1, 7, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (13, 4, 8, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (14, 1, 8, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (15, 4, 9, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (16, 4, 10, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (17, 2, 10, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (18, 4, 11, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (19, 4, 12, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (20, 4, 13, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (21, 3, 13, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (22, 4, 14, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (23, 9, 14, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (24, 4, 15, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (25, 4, 16, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (26, 3, 16, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (27, 4, 17, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (28, 4, 18, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (29, 4, 19, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (30, 1, 19, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (31, 9, 19, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (32, 4, 20, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (33, 1, 20, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (34, 4, 21, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (35, 4, 22, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (36, 1, 22, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (37, 3, 22, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (38, 4, 23, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (39, 4, 24, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (40, 10, 25, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (41, 2, 25, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (42, 6, 26, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (43, 1, 26, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (44, 10, 27, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (45, 1, 27, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (46, 3, 27, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (47, 4, 28, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (48, 1, 28, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (49, 4, 29, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (50, 1, 29, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (51, 6, 30, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (52, 1, 30, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (53, 4, 31, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (54, 7, 32, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (55, 1, 32, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (56, 4, 33, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (57, 10, 34, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (58, 3, 34, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (59, 4, 35, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (60, 2, 35, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (61, 6, 36, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (62, 1, 36, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (63, 4, 37, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (64, 1, 37, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (65, 2, 37, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (66, 4, 38, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (67, 10, 39, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (68, 9, 39, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (69, 4, 40, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (70, 10, 41, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (71, 4, 42, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (72, 10, 43, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (73, 2, 43, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (74, 10, 44, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (75, 2, 44, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (76, 9, 44, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (77, 7, 45, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (78, 1, 45, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (79, 5, 46, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (80, 10, 47, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (81, 2, 47, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (82, 5, 48, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (83, 5, 49, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (84, 8, 49, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (85, 5, 50, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (86, 8, 50, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (87, 5, 51, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (88, 8, 51, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (89, 2, 51, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (90, 9, 51, '2023-04-01 11:11:53.358491+02', NULL);
INSERT INTO public.tag_has_trek VALUES (91, 5, 52, '2023-04-01 11:11:53.358491+02', NULL);
...
--
-- Name: tag_has_trek_id_seq; Type: SEQUENCE SET; Schema: public; Owner: lionel
--
...
--
-- Name: tag_id_seq; Type: SEQUENCE SET; Schema: public; Owner: lionel
--
...
--
-- Data for Name: trek; Type: TABLE DATA; Schema: public; Owner: lionel
--
...
', 'La randonnée vers l''Aiguillette des Houches offre un parcours original et accessible. Cette balade emprunte une partie du GR du Tour du Mont-Blanc et offre des vues panoramiques sur les sommets alpins. Entre nature sauvage et paysages grandioses, l''Aiguillette des Houches est une expérience inoubliable pour tous les amoureux de la montagne.', 'La randonnée de l''Aiguillette des Houches est une expérience incroyable pour tous les amateurs de nature et de montagne. Située dans le massif des Aiguilles Rouges en France, cette randonnée offre des vues spectaculaires sur les montagnes environnantes, les glaciers et les vallées environnantes.
...
Une fois arrivés au sommet de l''Aiguillette des Houches, les randonneurs sont récompensés par une vue panoramique à couper le souffle sur les montagnes environnantes, y compris le Mont-Blanc. C''est également un endroit idéal pour une pause déjeuner et une séance de photos mémorable.', 10300, 781, 2285, 1389, 1, 3, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/g1M87XvUXq?iframe');
INSERT INTO public.trek VALUES (2, 'La Bourgeoise', 'Aller-retour', '1 heure et 40 minutes', 'La Clusaz', '46.121308, 6.709261', 'https://www.visugpx.com/download.php?id=iLM5Ydwng5', 'Venez découvrir la randonnée de La Bourgeoise en Haute-Savoie, une boucle offrant des vues spectaculaires sur les montagnes des Aravis, le Mont Blanc et le lac d''Annecy. Vous aurez l''occasion de traverser des forêts, des ruisseaux et des prairies, et de découvrir de charmants hameaux typiques de la région. Alors, mettez vos chaussures de randonnée et partez à la découverte de cette belle randonnée en Haute-Savoie !', 'La randonnée de la Bourgeoise est une magnifique randonnée située dans la région de Haute-Savoie en France. Elle est considérée comme une randonnée facile avec une distance de 7 km et un dénivelé positif de 300 mètres. Elle est donc accessible à la plupart des randonneurs, mais il est important de noter qu''il peut y avoir des parties un peu plus difficiles en fonction des conditions météorologiques.
...
Le point culminant de la randonnée est le sommet de la Bourgeoise, qui offre une vue panoramique sur les montagnes environnantes. C''est un endroit idéal pour faire une pause et profiter du paysage.', 6800, 300, 1759, 1642, 2, 2, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/iLM5Ydwng5?iframe');
INSERT INTO public.trek VALUES (3, 'Le Signal des Voirons', 'Aller-retour', '1 heure', 'Saint-Paul-en-Chablais', '46.226001, 6.358242', 'https://www.visugpx.com/download.php?id=YQnPViiAR4', 'Vous cherchez une randonnée inoubliable à faire en Haute-Savoie ? Partez à la découverte du Signal des Voirons, un sommet culminant à plus de 1400 mètres d''altitude offrant une vue imprenable sur les montagnes de la région. En hiver, vous pourrez profiter de sentiers enneigés à travers la forêt, tandis qu''en été, les paysages verdoyants et la chaleur estivale vous permettront de découvrir des vues imprenables sur la région.', 'La randonnée vers le Signal des Voirons commence au monastère situé dans la ville de Saint-Paul-en-Chablais. Ce monastère, fondé en 1295, est un joyau de l''architecture gothique savoyarde, qui abrite encore aujourd''hui une communauté de religieuses.
...
Après avoir savouré la vue au sommet, les randonneurs peuvent redescendre en suivant le même sentier, en admirant les paysages magnifiques de la région et en profitant du calme de la nature alpine. La randonnée vers le Signal des Voirons est une expérience inoubliable pour les amoureux de la montagne, quel que soit la saison.', 3000, 182, 1475, 1360, 10, 2, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/YQnPViiAR4?iframe');
INSERT INTO public.trek VALUES (4, 'La Pointe d''Andey', 'Aller-retour', '2 heures et 40 minutes', 'Brison', '46.033167, 6.427444', 'https://www.visugpx.com/download.php?id=3cel1ALjfM', 'Partez à la découverte de la beauté naturelle de la Pointe d''Andey en Haute-Savoie, que ce soit sous la neige ou dans les prairies verdoyantes. Admirez les panoramas à couper le souffle sur les montagnes environnantes tout en profitant de l''air frais de la montagne. Cette randonnée est l''occasion idéale de s''évader de la vie quotidienne et de se ressourcer en pleine nature. Rejoignez-nous pour une expérience inoubliable dans les Alpes françaises !', 'Partez à l''aventure en empruntant le sentier de randonnée qui vous mènera depuis le plateau de Solaison jusqu''à la Pointe d''Andey en Haute-Savoie. Cette randonnée, d''une durée de 3 heures environ, vous offrira une expérience inoubliable au cœur des Alpes françaises.
...
Cette randonnée est donc une occasion unique d''admirer la beauté naturelle de la Haute-Savoie tout en se ressourçant en pleine nature.', 3000, 350, 1845, 1510, 3, 2, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/3cel1ALjfM?iframe');
INSERT INTO public.trek VALUES (5, 'Le Plateau des Glières', 'En boucle', '2 heures et 40 minutes', 'Thorens Glières', '45.963214, 6.326408', 'https://www.visugpx.com/download.php?id=qpnnECxijG', 'Découvrez la beauté hivernale du Plateau des Glières en empruntant l''itinéraire court et facile menant au sommet de la montagne des Auges. Profitez d''un panorama époustouflant sur la chaine du Mont Blanc, le Chablais, le Bassin Lémanique et le Jura depuis le confort douillet du chalet. Cette randonnée accessible offre un moment de détente en pleine nature, loin du tumulte de la ville.', 'Situé en Haute-Savoie, le Plateau des Glières est une destination prisée pour les randonneurs et les amateurs de ski de fond. Mais saviez-vous que c''est aussi un lieu idéal pour une randonnée familiale hivernale ?
...
Le Plateau des Glières est également connu pour son riche patrimoine historique. En effet, c''est ici qu''a eu lieu la fameuse bataille des Glières en 1944, où des résistants français ont affronté les troupes allemandes. Vous pourrez découvrir cet épisode de l''histoire de la France en visitant le musée de la Résistance et en suivant le sentier commémoratif.', 8000, 230, 1465, 1385, 3, 2, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/qpnnECxijG?iframe');
INSERT INTO public.trek VALUES (6, 'Le Môle', 'En boucle', '2 heures et 30 minutes', 'St Jean de Tholome', '46.099143, 6.438364', 'https://www.visugpx.com/download.php?id=FQ6nQR0QHP', 'Vous cherchez une randonnée emblématique pour découvrir la région de Haute-Savoie ? Le Môle est un grand classique facilement visible depuis Genève, offrant un panorama à 360° sur les massifs environnants, tels que les Bornes, le Giffre et le Chablais. Cette randonnée, accessible à tous les niveaux, est une expérience inoubliable à vivre en famille ou entre amis. Marchez à travers les forêts verdoyantes et les alpages pittoresques.', 'La randonnée du Môle peut être démarrée depuis plusieurs points de départ, dont le parking de Beroud. 
...
Prévoyez environ 3 heures pour cette randonnée de 9 km et 800 mètres de dénivelé positif.', 9000, 800, 1820, 1123, 5, 3, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/FQ6nQR0QHP?iframe');
INSERT INTO public.trek VALUES (7, 'Arête de Taillefer', 'En boucle', '1 heure et 50 minutes', 'Duingt', '45.827117, 6.202763', 'https://www.visugpx.com/download.php?id=AQtLuqYL01', 'Partez à la découverte de l''arête de Taillefer et vivez une expérience de randonnée inoubliable à partir de l''église de Duingt. Dominant le lac d''Annecy, cette arête offre un panorama à couper le souffle sur les montagnes alpines environnantes. Vous traverserez des paysages spectaculaires, des crêtes abruptes et des falaises escarpées. L''itinéraire de cette randonnée est accessible à tous les randonneurs.', 'La randonnée de l''arête de Taillefer, au départ de l''église de Duingt, est une boucle exigeante mais incroyablement gratifiante de 7 km, avec un dénivelé de 440 mètres et une durée moyenne de 2 heures.
...
La descente commence ensuite par un sentier raide et rocheux qui mène à un col. De là, le sentier continue à travers les alpages, offrant des vues spectaculaires sur les montagnes environnantes.', 7000, 440, 761, 450, 4, 2, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/AQtLuqYL01?iframe');
INSERT INTO public.trek VALUES (8, 'Mont Veyrier et Mont Baron', 'En boucle', '2 heures et 50 minutes', 'Annecy-le-Vieux', '45° 54,493’, 006° 10,362’', 'https://www.visugpx.com/download.php?id=oURZMlTEcK', 'Découvrez une randonnée exceptionnelle près d''Annecy en empruntant les sentiers du Mont Veyrier et du Mont Baron ! Offrant une vue panoramique sur le lac et les montagnes environnantes, cette excursion de 4 heures vous promet une expérience inoubliable en plein cœur de la nature. Que vous soyez un randonneur débutant ou expérimenté, cette balade est un incontournable pour les amoureux de la montagne et des paysages époustouflants.', 'La randonnée commence à la base du Mont Veyrier, où un petit parking est disponible pour les randonneurs. Le début de la montée est assez doux, avec un sentier qui serpente à travers les arbres. Au fur et à mesure que vous vous élevez, vous pouvez déjà sentir l''air frais de la montagne vous remplir les poumons.
...
Enfin, la randonnée se termine par une petite promenade le long de la rivière, qui mène jusqu''au point de départ. Avec ses 11 km et 1150 mètres de dénivelé, cette randonnée est réservée aux randonneurs expérimentés et en bonne condition physique. Mais les paysages époustouflants, les vues panoramiques sur la région et la visite des grottes en valent largement la peine !', 10800, 1141, 1480, 611, 9, 4, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/o8OKX3dNAb?iframe');
INSERT INTO public.trek VALUES (10, 'Le Mont Forchat', 'Aller-retour', '2 heures et 30 minutes', 'Habère-Poche', '46.255633, 6.505342', 'https://www.visugpx.com/download.php?id=7zu39xS7HZ', 'Découvrez les merveilles de la nature en randonnant sur le Mont Forchat, situé à proximité d''Habère-Poche ! Cette randonnée est une véritable invitation à l''évasion, offrant des panoramas exceptionnels sur les massifs alpins environnants. Le parcours est varié et accessible à tous les niveaux, des plus novices aux plus expérimentés.', 'La randonnée du Mont Forchat est une expérience inoubliable pour les amateurs de montagne et de nature, offrant des vues panoramiques spectaculaires sur les montagnes environnantes.
...
La descente se fait par le même chemin que celui de l''aller, offrant une occasion supplémentaire d''admirer les paysages alpins.', 15500, 710, 1520, 850, 5, 3, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/7zu39xS7HZ?iframe');
INSERT INTO public.trek VALUES (11, 'La Montage de Sous Dine', 'Aller-retour', '3 heures', 'Thônes', '46.014324, 6.301193', 'https://www.visugpx.com/download.php?id=iwVuBO4qRS', 'Partez à la découverte de la majestueuse montagne Sous Dine en Haute-Savoie lors d''une randonnée inoubliable ! Cette balade vous permettra de découvrir des paysages à couper le souffle, entre forêts verdoyantes et crêtes escarpées. Au sommet, vous serez récompensé par une vue panoramique à 360 degrés sur les massifs alentours, dont le Mont Blanc.', 'La randonnée du Sous Dine est une belle promenade dans le massif des Bornes, situé en Haute-Savoie. Elle offre une vue imprenable sur les montagnes environnantes, y compris le massif du Mont Blanc.
...
Il est important de noter que la randonnée du Sous Dine est considérée comme une randonnée de difficulté moyenne à difficile en raison de la pente raide et des passages escarpés.', 11000, 990, 1996, 992, 3, 3, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/iwVuBO4qRS?iframe');
INSERT INTO public.trek VALUES (12, 'Le Mont Ouzon', 'Aller-retour', '3 heures et 15 minutes', 'Col du Corbier', '46.2286, 6.6866', 'https://www.visugpx.com/download.php?id=qWxbenCe05', 'Découvrez la beauté sauvage du massif Chablais avec la randonnée du Mont Ouzon en Haute-Savoie. Cette excursion offre des vues panoramiques à couper le souffle sur les montagnes environnantes et une immersion totale dans la nature préservée.', 'La randonnée calcaire du Mont Ouzon dans le massif Chablais en Haute-Savoie offre une expérience de randonnée exceptionnelle en partant du Col du Corbier, situé à une altitude de 1240 mètres. Le départ de la randonnée est marqué par une vue imprenable sur les sommets alentours et les alpages du massif.
...
', 7500, 675, 1833, 1240, 5, 3, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/qWxbenCe05?iframe');
INSERT INTO public.trek VALUES (13, 'Les Chalêts de Sales', 'Aller-retour', '3 heures et 30 minutes', 'Sixt-Fer-A-Cheval', '46.083834, 6.735949', 'https://www.visugpx.com/download.php?id=iH5PYk1uKw', 'Partez à l''aventure dans l''un des plus beaux décors de la Haute-Savoie en explorant la randonnée des Chalets de Sales près de Sixt-Fer-à-Cheval. Cette randonnée vous emmènera à travers des paysages magnifiques, en passant par des forêts de sapins et des alpages verdoyants. 

Les Chalets de Sales est une excursion emblématique de la région de Sixt-Fer-à-Cheval en Haute-Savoie, accessible à tous, y compris aux familles avec enfants.', 'Le sentier débute à la cascade de Rouget, l''un des sites naturels les plus impressionnants de la région. De là, la randonnée se poursuit le long de la rivière, en passant par des paysages de forêts et de prairies. Vous pourrez admirer les montagnes environnantes et les cascades qui jalonnent le chemin.
...
Cette randonnée offre une expérience authentique de la nature et des traditions de la région.', 11000, 940, 1895, 1169, 6, 3, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/iH5PYk1uKw?iframe');
INSERT INTO public.trek VALUES (14, 'Le Parmelan', 'Aller-retour', '2 heures et 30 minutes', 'Villaz', '45.974125, 6.240705', 'https://www.visugpx.com/download.php?id=aZBmanJBPU', 'Venez découvrir les paysages exceptionnels de la Haute-Savoie en randonnant sur les sentiers du Parmelan ! Cette randonnée vous emmènera sur les crêtes du massif, offrant des vues imprenables sur les montagnes environnantes et le lac d''Annecy. 

La randonnée du Parmelan est une expérience de randonnée inoubliable pour les amateurs de nature et de montagne, offrant des paysages spectaculaires et une belle aventure en Haute-Savoie.', 'La randonnée du Parmelan débute sur le parking des Puisots. Cette boucle de 11 km offre une vue imprenable sur les montagnes environnantes et le lac d''Annecy.
...
La randonnée du Parmelan est une expérience de randonnée inoubliable pour les amateurs de nature et de montagne, offrant des paysages spectaculaires et une belle aventure en Haute-Savoie.', 11300, 1200, 1823, 1140, 3, 4, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/aZBmanJBPU?iframe');
INSERT INTO public.trek VALUES (15, 'Sur Cou', 'En boucle', '4 heures', 'Orange', '46.027609, 6.325638', 'https://www.visugpx.com/download.php?id=ykCLiP32Z9', 'Partez à la conquête du sommet de "Sur Cou" en Haute-Savoie et découvrez des vues panoramiques époustouflantes. Cette randonnée offre un parcours de toute beauté dans un cadre naturel exceptionnel. Du sommet, vous pourrez admirer les Alpes et le lac Léman, un spectacle à couper le souffle. Une expérience inoubliable à partager en famille, entre amis ou en solo.', 'La randonnée "Sur Cou" est une expérience à ne pas manquer pour les amateurs de marche. Avec une longueur de 18 km, cette randonnée est parfaite pour ceux qui souhaitent s''engager dans une marche agréable et sportive en pleine nature. Le parcours offre un paysage magnifique tout au long du chemin, avec des vues panoramiques exceptionnelles sur les montagnes environnantes. Que vous soyez un randonneur expérimenté ou novice, cette randonnée est une occasion idéale pour explorer la beauté naturelle de la région.
...
Elle fait ensuite une boucle jusqu’au châlet de Balme et passe par le parking du Chesnet avant de retourner sur la base de loisir.', 18250, 1200, 1783, 1002, 3, 4, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/ykCLiP32Z9?iframe');
INSERT INTO public.trek VALUES (16, 'Le Cirque du Fer A Cheval', 'Aller-retour', '2 heures et 10 minutes', 'Sixt-Fer-A-Cheval', '46.077278, 6.836917', 'https://www.visugpx.com/download.php?id=6IS5ugGwoe', 'Partez à la découverte du Cirque du Fer-à-Cheval et laissez-vous émerveiller par la majesté de ce cirque, bordé de falaises de calcaire impressionnantes. 

Les cascades y sont nombreuses, notamment au printemps. 

En plus de cette beauté naturelle, la commune est également une réserve naturelle protégée où l''on peut apercevoir des bouquetins et des marmottes. Ne manquez pas cette expérience de randonnée unique.', 'Le départ se fait depuis le parking du Cirque du Fer à Cheval, où les randonneurs peuvent admirer la beauté du paysage avant de commencer leur randonnée. Le sentier commence doucement à travers les prairies verdoyantes, longeant les falaises impressionnantes de calcaire.
...
Cette randonnée dure environ 2 heures et est accessible à tous les niveaux de randonneurs. Cette randonnée est une expérience inoubliable pour tous les amoureux de la nature.', 11000, 400, 1193, 842, 7, 2, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/6IS5ugGwoe?iframe');
INSERT INTO public.trek VALUES (17, 'Le Trou de la Mouche', 'En boucle', '2 heures et 30 minutes', 'La Clusaz', '45.920408, 6.480487', 'https://www.visugpx.com/download.php?id=CipsIiJCWl', 'La randonnée du Trou de la Mouche à La Clusaz est une belle balade de 11 km qui offre une vue panoramique sur les montagnes environnantes. Le point culminant est le Trou de la Mouche, un passage naturel dans la roche à 2 260 mètres d''altitude, offrant une vue imprenable sur la chaîne des Aravis.', 'La randonnée du Trou de la Mouche, c''était une aventure incroyable ! Au départ, on était un peu anxieux, on ne savait pas trop à quoi s''attendre. Mais dès les premiers pas, on a été époustouflés par la beauté des paysages. On marchait tranquillement, en admirant les troupeaux de vaches et les alpages verdoyants qui s''étendaient à perte de vue.
...
En fin de journée, on est retournés au parking du col des Aravis, fatigués mais heureux. Cette randonnée nous a permis de découvrir la beauté de la Haute-Savoie, ses villages alpins typiques, ses montagnes majestueuses et ses paysages à couper le souffle. Une expérience à vivre absolument !', 11200, 1150, 2425, 1420, 2, 4, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/CipsIiJCWl?iframe');
INSERT INTO public.trek VALUES (18, 'Les Rochers de Leschaux', 'En boucle', '2 heures', 'Brison', '46.033167, 6.427444', 'https://www.visugpx.com/download.php?id=xoIBu2smMD', 'Le Tour des Rochers de Leschaux est une randonnée de 8,5 km située sur le Plateau de Solaison en Haute-Savoie. Elle offre des vues panoramiques sur les montagnes environnantes et permet de découvrir des formations rocheuses étonnantes. La randonnée peut être réalisée en environ 2 heures.', 'Le départ de la randonnée se trouve au parking de la station de ski de Solaison. La randonnée commence par une montée assez raide sur un chemin forestier qui mène à une crête offrant une vue panoramique sur les montagnes environnantes. Ensuite, la randonnée se poursuit sur une crête étroite et rocheuse, offrant une vue à 360 degrés sur les montagnes et la vallée en contrebas.
...
Le retour s''effectue par le même sentier, en suivant la crête jusqu''au chalet de l''Aulp. La randonnée complète prend environ 3 à 4 heures, avec une distance totale d''environ 12 km et un dénivelé positif d''environ 1500 mètres.', 12700, 1550, 2302, 1218, 3, 4, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/U0GFzUG1n7?iframe');
INSERT INTO public.trek VALUES (20, 'Le Lac de Pormenaz', 'En boucle', '3 heures et 40 minutes', 'Passy', '45.951173, 6.739291', 'https://www.visugpx.com/download.php?id=KG0ATWlp83', 'Au cœur de la réserve naturelle de Passy se trouve le Lac de Pormenaz, une destination estivale incontournable offrant une sortie modulable à souhait. Cette balade familiale mène tranquillement au torrent du Souay et offre une vue imprenable sur les Rochers des Fiz et l''imposante Pointe Noire.', 'La randonnée commence au parking de Plaine Joux et suit un sentier à travers la forêt jusqu''au Lac Vert. En cours de route, vous pourrez admirer les vues spectaculaires sur la vallée en contrebas.
...
Après avoir atteint le Lac de Pormenaz, vous pourrez vous arrêter pour vous rafraîchir, avant de commencer votre descente vers le parking de Plaine Joux.', 13300, 1030, 1976, 1201, 6, 4, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/KG0ATWlp83?iframe');
INSERT INTO public.trek VALUES (21, 'La Dent d''Oche', 'Aller-retour', '1 heure et 40 minutes', 'Bernex', '46.346207, 6.707540', 'https://www.visugpx.com/download.php?id=gRzhsAyaOq', 'Découvrez la majestueuse Dent d''Oche, un promontoire pointu offrant un panorama à 360° sur le lac Léman et les sommets du Chablais. Le sentier efficace traversant les alpages mène au refuge d''Oche, impressionnant nid d''aigle, puis à un couloir raide équipé de chaînes. En haut, partagez le sommet avec les bouquetins et profitez de la vue époustouflante sur la région de Gavot.', 'Je me suis réveillé tôt ce matin, impatient de partir à l''aventure dans les montagnes de la Haute-Savoie. J''avais entendu parler de la Dent d''Oche, un promontoire bien pointu offrant une vue à couper le souffle sur le lac Léman et les sommets du Chablais.
...
Cette randonnée de 6,8 km a été l''occasion de découvrir la nature à l''état pur et de profiter de toutes les merveilles que la montagne peut offrir. Le parcours modéré nous a permis de profiter pleinement de chaque instant, sans pour autant nous épuiser, et nous avons terminé la randonnée avec la satisfaction d''avoir accompli un beau défi tout en étant ressourcés par la beauté du paysage.', 6800, 780, 1917, 1181, 5, 3, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/WKkUcZTaEc?iframe');
INSERT INTO public.trek VALUES (23, 'La Pointe de Chavasse', 'En boucle', '4 heures', 'Taninges', '46.175154, 6.606456', 'https://www.visugpx.com/download.php?id=YhewtOAyI7', 'Partez à l''aventure dans le Géoparc du Chablais en Haute-Savoie ! Cette randonnée vous emmènera de La Villiaz de Combafou à la Pointe de Chavasse, offrant une vue panoramique sur le massif du Chablais, le Mont Blanc et les Dents du Midi. Pour les plus intrépides, poursuivez votre parcours en traversant le Roc d''Enfer pour atteindre trois sommets. Un itinéraire exigeant mais gratifiant, avec des passages rocheux et des paysages à couper le souffle.', 'La randonnée débute à La Villiaz de Combafou, un petit village de montagne près de Taninges. Le départ se fait depuis le parking de l''église, où une indication pour le sentier de randonnée est visible. Le sentier monte rapidement et les premiers kilomètres sont assez raides. On traverse une forêt de conifères et de feuillus avant d''arriver au Col du Foron.
...
Nous profitons de cet instant de calme et de contemplation, avant d''entamer la descente vers Bellajoux. Le sentier est moins abrupt que celui de la montée, mais nous devons tout de même faire attention à ne pas glisser sur les pierres.', 7200, 699, 1896, 1040, 3, 3, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/v63ILibxNO?iframe');
INSERT INTO public.trek VALUES (25, 'L''aiguille du Midi', 'Aller-retour', '1 heure et 40 minutes', 'Chamonix', '45.918303, 6.870021', 'https://www.visugpx.com/download.php?id=3QQkGgZ0W5', 'Préparez-vous à vivre une expérience hors du commun en vous élevant jusqu''au sommet de l''Aiguille du Midi, à plus de 3 800 mètres d''altitude, grâce au téléphérique de Chamonix. Découvrez une vue panoramique à couper le souffle sur les sommets alpins et vivez des sensations fortes en marchant sur la passerelle du vide. L''aventure vous attend à l''Aiguille du Midi !', 'L''ascension de l''Aiguille du Midi en téléphérique est une aventure inoubliable qui vous transporte dans les hauteurs vertigineuses des montagnes alpines.
...
Enfin, vous pouvez vous détendre dans le restaurant panoramique en savourant une boisson chaude et des pâtisseries locales tout en admirant la vue incroyable.', 900, 0, 3842, 1035, 8, 1, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/3QQkGgZ0W5?iframe');
INSERT INTO public.trek VALUES (26, 'Le Lac de Machilly', 'En boucle', '1 heure', 'Machilly', '46.1732, 6.3276', 'https://www.visugpx.com/download.php?id=pZCDG6dNEv', 'Promenez-vous autour du lac de Machilly en Haute-Savoie pour profiter de superbes vues sur les montagnes environnantes.', 'La promenade autour du lac de Machilly est une agréable balade à travers la campagne de Haute-Savoie. Le lac, qui s''étend sur environ 2,5 kilomètres, est entouré de verdure et offre de jolies vues sur les montagnes environnantes.
...
Le lac de Machilly est un lieu de détente populaire pour les habitants de la région et les visiteurs, et est particulièrement fréquenté pendant les mois d''été pour permettre de profiter de la beauté naturelle de la Haute-Savoie.', 3000, 18, 519, 500, 10, 1, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/pZCDG6dNEv?iframe');
INSERT INTO public.trek VALUES (27, 'Le Lac du Vallon', 'Aller-retour', '2 heures', 'Bellevaux', '46.2187, 6.55747', 'https://www.visugpx.com/download.php?id=bnPNCGWiWJ', 'Partez à l''aventure sur cet itinéraire très populaire, près de Bellevaux.

Considéré comme un parcours modéré, il faut un peu moins de 2h pour le parcourir', 'Il était une fois, une belle journée ensoleillée où j''ai décidé de partir en randonnée vers le lac du Vallon et la cascade de la Diomaz près de Bellevaux. Je me suis préparé avec mon sac à dos, de l''eau et une collation, ainsi que mes chaussures de randonnée.
...
Après avoir profité de la cascade, j''ai commencé à redescendre. La descente était plus facile et j''ai pu profiter de la vue en sens inverse. En fin d''après-midi, je suis rentré chez moi, satisfait de cette belle journée en pleine nature.', 4800, 210, 1233, 1077, 5, 1, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/bnPNCGWiWJ?iframe');
INSERT INTO public.trek VALUES (28, 'La Pointe de Marcelly', 'En boucle', '5 heures', 'Sommand', '46.16109, 6.5548', 'https://www.visugpx.com/download.php?id=XG1Xi2fhG1', 'Randonneurs, envie d''un défi accessible aux vues spectaculaires ? La boucle du Pic du Marcelly vous offre un voyage à travers les paisibles pâturages de Praz-de-Lys et les crêtes aériennes de la pointe de la Couenasse, tout en vous récompensant avec une vue imprenable sur la Vallée de l''Arve depuis le sommet. Ne manquez pas cette randonnée inoubliable !', 'La randonnée du Pic du Marcelly est une boucle de 18 km qui débute au parking de Sommand. Le sentier suit une montée douce à travers les pâturages du Praz-de-Lys, menant à un sommet nommé la pointe de la Couenasse. De là, les randonneurs peuvent admirer une vue panoramique de la Vallée de l''Arve et des montagnes environnantes.
...
La descente est une promenade paisible à travers les forêts et les champs, avec des vues occasionnelles sur la vallée en contrebas. Les randonneurs finissent leur boucle au parking de Sommand.', 18000, 1220, 1999, 1415, 5, 4, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/XG1Xi2fhG1?iframe');
INSERT INTO public.trek VALUES (29, 'Le Lac de Lessy', 'Aller-retour', '3 heures et 30 minutes', 'Chinaillon', '45.974562, 6.453521', 'https://www.visugpx.com/download.php?id=VnlZB0z9R1', 'La randonnée du lac de Lessy près de Chinaillon en Haute-Savoie offre une vue imprenable sur les montagnes environnantes. Cette randonnée de 3h30 heures aller-retour, d''une distance de 9 kilomètres et d''un dénivelé d’environ 700 mètres, est accessible aux randonneurs de tous niveaux. Le lac de montagne est un endroit idéal pour pique-niquer et se détendre avant de revenir sur ses pas.', 'La randonnée débute au parking du col de la Colombière (1613m d''altitude). Le sentier est clairement indiqué par un panneau "Lac de Lessy". Le début du chemin est assez raide et se fait en forêt. Le sentier est balisé et facile à suivre.
...
Pour le retour, il suffit de reprendre le même chemin en sens inverse.', 8600, 670, 1945, 1300, 3, 3, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/VnlZB0z9R1?iframe');
INSERT INTO public.trek VALUES (30, 'Le Lac de Plagnes', 'Aller-retour', '1 heure', 'Abondance', '46.248820, 6.754352', 'https://www.visugpx.com/download.php?id=kRjZqnWERS', 'La promenade du lac de Plagnes près d''Abondance est une belle randonnée de 2,5 km autour d''un lac de montagne magnifique. Le sentier est facile et convient à toute la famille. Vous pourrez admirer de superbes vues sur les montagnes environnantes et profiter d''un cadre paisible et naturel.', 'La promenade du lac de Plagnes est un joyau caché dans la belle région d''Abondance en Haute-Savoie. La balade facile de 2,5 km autour du lac est un véritable havre de paix pour les amoureux de la nature, où l''on peut se ressourcer en admirant l''eau qui reflète les montagnes environnantes.
...
La promenade du lac de Plagnes est une activité familiale idéale pour tous les amoureux de la nature, que ce soit pour une balade tranquille, une partie de pêche ou une randonnée plus sportive. Ce lieu enchanteur offre une vue imprenable sur les montagnes environnantes et est un véritable havre de paix pour les visiteurs qui souhaitent s''échapper du tumulte de la vie urbaine et se ressourcer dans la nature.', 2500, 130, 1204, 1175, 5, 1, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/kRjZqnWERS?iframe');
INSERT INTO public.trek VALUES (31, 'Les Dents de Lanfon', 'Aller-retour', '3 heures et 10 minutes', 'Alex', '45.879964, 6.230057', 'https://www.visugpx.com/download.php?id=gEL4svjJNV', 'Découvrez une randonnée éprouvante, mais gratifiante, à proximité d''Annecy. Ce sentier en boucle vous mènera à un belvédère à couper le souffle sur le lac d''Annecy. Etes vous prêt à relever le défi de cette randonnée pour une expérience inoubliable ?', 'Partons à la découverte de la randonnée menant aux Dents de Lanfon, à proximité de Menthon-Saint-Bernard. Le sentier débute au niveau de Les Villard-Dessus et prend la direction de la Cascade d''Alex. 
...
Le retour dans la forêt est agréable et nous offre des moments agréables avec la nature environnante.', 11000, 1100, 1814, 761, 3, 4, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/gEL4svjJNV?iframe');
INSERT INTO public.trek VALUES (32, 'Le Lac Blanc', 'Aller-retour', '4 heures et 10 minutes', 'Tré-Le-Champs', '45.9968, 6.92647', 'https://www.visugpx.com/download.php?id=HFRzPo8mv3', 'Le lac Blanc de Haute-Savoie est un magnifique lac d''origine glaciaire situé dans la vallée de Chamonix, entouré de sommets tels que l''Aiguille du Midi. Il est accessible depuis le téléphérique de la Flégère ou en randonnée depuis la vallée. La randonnée offre une vue panoramique imprenable sur les montagnes.', 'La randonnée au Lac Blanc depuis Tré-le-Champ est une randonnée classique de la région de Chamonix, qui offre des vues spectaculaires sur le massif du Mont Blanc et les Aiguilles Rouges. Le départ de la randonnée se fait depuis le parking de la Flégère, situé à environ 20 minutes à pied de Tré-le-Champ.
...
Le retour se fait par le même sentier que l''aller, offrant des vues différentes sur les montagnes environnantes.', 8000, 990, 2352, 1470, 1, 4, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/HFRzPo8mv3?iframe');
INSERT INTO public.trek VALUES (33, 'Le Grammont', 'Aller-retour', '5 heures', 'Vouvry', '46.3382, 6.848297', 'https://www.visugpx.com/download.php?id=HyowI62iAs', 'Le Grammont, situé au cœur du Chablais, offre une randonnée pittoresque passant par le Lac de Taney, pour atteindre le sommet offrant une vue plongeante sur le Léman et un panorama sur les massifs alentours.', 'Le point de départ de la randonnée est facilement accessible en voiture, et il y a un parking à proximité du lieu-dit Le Flon. Le sentier de randonnée commence par une montée régulière qui traverse une belle forêt de pins, avant d''atteindre le lac de Taney. Ce dernier est un site naturel préservé, entouré de montagnes et d''une beauté à couper le souffle.
...
Le point culminant de la randonnée est la croix du sommet, qui offre une vue panoramique à 360 degrés sur les montagnes environnantes et les vallées alpines. Le panorama s''étend du Mont Blanc jusqu''au Jura en passant par le Grand Combin et le Haut-Giffre.', 12100, 1020, 2153, 1082, 5, 4, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/HyowI62iAs?iframe');
INSERT INTO public.trek VALUES (34, 'La Route des Cascades', 'En boucle', '1 heure et 30 minutes', 'Thônes', '45.89969, 6.29201', 'https://www.visugpx.com/download.php?id=wlpmcIO9oO', 'Découvrez la beauté naturelle de la Haute-Savoie sur la Route des Cascades près de Thônes. Une randonnée époustouflante à travers des cascades et des paysages somptueux. L''aventure parfaite pour les amoureux de la nature et du plein air !', 'La Route des Cascades près de Thônes en Haute-Savoie est une randonnée inoubliable qui vous fera découvrir la beauté naturelle spectaculaire de la région. La randonnée commence à la cascade de Morette et suit une série de cascades à travers une forêt dense, offrant des vues incroyables sur les torrents d''eau qui s''écoulent en cascade à travers les rochers.
...
La randonnée se termine au sommet de la cascade de Tines, une cascade de 30 mètres qui offre une vue imprenable sur les montagnes environnantes et les vallées verdoyantes. Vous pouvez également explorer les grottes et les rochers autour de la cascade pour une expérience encore plus immersive.', 3000, 133, 702, 591, 3, 2, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/wlpmcIO9oO?iframe');
INSERT INTO public.trek VALUES (35, 'Le Balcon des Mémises', 'En boucle', '3 heures et 30 minutes', 'Thollon-Les-Mémises', '46.36989, 6.68904', 'https://www.visugpx.com/download.php?id=2zz02ivtUQ', 'Le Balcon des Mémises offre une magnifique randonnée estivale avec des sentiers en forêt, escalade aisée et balade le long des crêtes. En hiver, la boucle à raquettes par Creusaz offre une vue imprenable sur le Léman et le Chablais.', 'Le Balcon des Mémises est une randonnée emblématique de la région offrant une vue imprenable sur le Léman, le Chablais et la chaîne du Jura. Le départ se fait depuis le parking de Creusaz et suit une boucle de 10 km avec 700 m de dénivelé.
...
En hiver, le Lac Vert offre une atmosphère de conte de fées avec ses eaux gelées et ses paysages enneigés. La promenade autour du lac est également possible en hiver, mais l''accès se fait à pied ou en raquettes, car la route est fermée aux voitures.', 2000, 10, 1200, 1190, 1, 1, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/eFsqInGzhE?iframe');
INSERT INTO public.trek VALUES (37, 'Le Lac de Peyre', 'Aller-retour', '2 heures et 40 minutes', 'Col de la Colombière', '45.99222, 6.47554', 'https://www.visugpx.com/download.php?id=GFdJVap1oC', 'Le Lac de Peyre est une destination idéale pour les familles en quête d''une balade facile mais spectaculaire. Le sentier bien balisé, malgré sa raideur, offre un accès facile au lac entouré de gros blocs de rochers, faisant de cette excursion un beau challenge.', 'La randonnée jusqu''au Lac de Peyre est une excursion incontournable pour ceux qui recherchent une balade facile mais spectaculaire en montagne. Niché au cœur du massif des Aravis, le lac se trouve à environ 2 heures de marche depuis le parking de la Balme de Thuy.
...
Le Lac de Peyre est une destination de rêve pour les familles avec enfants, car le sentier est facile et ne présente pas de difficultés particulières. Le lac est entouré d’herbes où vous pouvez vous détendre et pique-niquer tout en admirant les sommets environnants. Les eaux cristallines du lac invitent également les plus courageux à une baignade rafraîchissante en été.', 5000, 550, 2085, 1617, 2, 2, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/GFdJVap1oC?iframe');
INSERT INTO public.trek VALUES (38, 'Le Pic de Jalouvre', 'Aller-retour', '2 heures et 50 minutes', 'Col de la Colombières', '45.99239, 6.47588', 'https://www.visugpx.com/download.php?id=1pcMYzJI4K', 'Cette randonnée de 5,5 km sur des sentiers alpins et rocheux offre des vues spectaculaires et une opportunité d''observer la faune, en particulier les bouquetins. 

Attention cependant, le dénivelé et le passage délicat via un pierrier raide jusqu''au Col du Rasoir la rendent difficile et déconseillée par temps de pluie.', 'La randonnée débute au niveau d''un lacet de la route qui mène au col de Colombière.
...
De là, il est possible d''admirer le lac de Lessy et de descendre en suivant le sentier qui passe par les Chalets de Lessy. Après avoir contourné le lac par la droite, le sentier monte en direction du Col de la Forclaz. De la, un petit sentier peu incliné vous fera traverser un pierrier et le flanc de l''aiguille verte, puis le sentier s''élèvera sur la droite. La descente se fera à travers l''alpage, en passant par une Via Ferrata jusqu''à retrouver le parking après une longue traversée sous une grosse barre rocheuse sur le flanc du Pic du Jalouvre.', 5500, 746, 2366, 1611, 2, 3, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/1pcMYzJI4K?iframe');
INSERT INTO public.trek VALUES (39, 'La Pointe de Miribel', 'Aller-retour', '1 heure', 'Habère-Poche', '46.205112, 6.472886', 'https://www.visugpx.com/download.php?id=7SB6k2xgKV', 'La Pointe de Miribel, dans la Vallée verte, est une randonnée facile avec une vue imprenable sur les alpages et les sommets environnants. Ce sommet isolé offre un panorama étendu sur le Léman et les massifs de Haute-Savoie jusqu''au Mont Blanc, idéal pour une remise en jambe de début de saison.', 'Le sentier menant à la Pointe de Miribel depuis les Chalets d’Ajon est bien balisé et offre une vue imprenable sur le sommet depuis le parking. Au Calvaire de Miribel, juste avant d''atteindre le sommet, le chemin devient plus rocailleux. Depuis le sommet, la vue sur les montagnes environnantes est spectaculaire, donnant envie de planifier de futures randonnées.

Pour la descente, il suffit de reprendre le même chemin emprunté pour monter.', 2700, 170, 1588, 1416, 5, 1, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/7SB6k2xgKV?iframe');
INSERT INTO public.trek VALUES (40, 'La pointe de Lachau', 'En boucle', '1 heure et 40 minutes', 'Abondance', '46.306958, 6.743061', 'https://www.visugpx.com/download.php?id=MN2BPoZmLA', 'La Pointe de Lachau, petite montagne des Alpes, offre une randonnée accessible avec une vue imprenable sur les Cornettes de Bise, le Mont Chauffé, la Dent d''Oche et la pointe de Bénévent. La dernière partie de l''arête est un peu raide, mais la balade permet de découvrir un paysage d''alpage au pied du Mont Chauffé. Un lieu idéal pour une escapade nature et une vue à 360° sur les montagnes alentour.', 'La randonnée ne nécessite pas de compétences particulières. 
...
Enfin, le sentier de l’aller se situe sur la gauche en direction du Mont Blanc.', 4900, 440, 1962, 1511, 5, 2, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/MN2BPoZmLA?iframe');
INSERT INTO public.trek VALUES (41, 'Le Désert de Platé', 'Aller-retour', '2 heures', 'Flaine', '46.005946, 6.695744', 'https://www.visugpx.com/download.php?id=C5KfOOYUWc', 'Le désert de Platé est un plateau désertique unique situé dans les Alpes françaises, caractérisé par des falaises abruptes et des grottes souterraines. Formé il y a environ 150 millions d''années, il est classé comme site naturel remarquable.', 'Le désert de Platé est une région unique située dans les Alpes françaises, plus précisément dans la Haute-Savoie, à une altitude de 2200 mètres. Ce qui le rend unique, c''est qu''il s''agit d''un plateau désertique qui s''étend sur plusieurs kilomètres, avec des rochers, des pierres et des falaises abruptes.
...
En raison de sa beauté naturelle et de son caractère unique, le désert de Platé est classé comme site naturel remarquable depuis 1942 et fait partie du Parc Naturel Régional du Massif des Bauges.', 8600, -914, 2543, 1639, 2, 2, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/C5KfOOYUWc?iframe');
INSERT INTO public.trek VALUES (42, 'La Pointe de Jottis', 'Aller-retour', '2 heures et 20 minutes', 'Megevette', '46.217190, 6.510175', 'https://www.visugpx.com/download.php?id=0qBWxrRlbP', 'Située dans la région du Chablais, non loin de la station d''Hirmentaz, la Pointe des Jottis est une randonnée à faire absolument pour tous les amateurs de nature et de belles vues. Avec ses 1548 mètres d''altitude, elle offre une vue imprenable sur le lac Léman et les sommets environnants.', 'Le sentier, empruntant le Tour des Crêtes de Bellevaux, est facile et accessible à tous, même aux débutants. La première partie du parcours est assez soutenue dans la forêt, puis il y a un long passage relativement plat dans le Pâturage des Jottis, avant une courte montée raide pour atteindre le sommet.
...
Cette randonnée est idéale pour la remise en jambes ou l''entraînement de début de saison. Elle convient parfaitement pour une journée de détente en famille ou entre amis. En automne, les couleurs des arbres et des paysages environnants ajoutent une touche supplémentaire à cette randonnée inoubliable.', 7000, 510, 1548, 980, 5, 2, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/0qBWxrRlbP?iframe');
INSERT INTO public.trek VALUES (43, 'Les Fermes du Maroly', 'En boucle', '1 heure et 50 minutes', 'Le Grand Bornand', '45.977939, 6.469398', 'https://www.visugpx.com/download.php?id=RXvIUflpmK', 'Une randonnée paisible dans l''alpage de Maroli offre des vues panoramiques exceptionnelles sur les Aravis et les massifs avoisinants. Le Crêt des Annes, en crête, offre une vue spectaculaire et les lacs artificiels de Maroly et de la Cour ajoutent également de la beauté à la région.', 'La randonnée en raquettes "Les Fermes du Maroly" est une balade idéale pour les familles ou les personnes qui recherchent une expérience de randonnée hivernale tranquille et pittoresque. Elle commence au hameau de "Les Bouts", situé à proximité de la station de ski de Chinaillon.
...
Cette randonnée est accessible à tous les niveaux et peut être accomplie en quelques heures. Les raquettes sont nécessaires pour parcourir la neige profonde et glissante, mais elles peuvent être louées dans les magasins de sports à proximité.', 5000, 210, 1460, 1330, 2, 2, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/RXvIUflpmK?iframe');
INSERT INTO public.trek VALUES (44, 'La Pointe de Beauregard', 'En boucle', '2 heures et 30 minutes', 'Manigod', '45.87694, 6.40512', 'https://www.visugpx.com/download.php?id=pZhT3ErwUl', 'Découvrez la beauté de la nature enneigée du Massif des Aravis en vous offrant une balade hivernale sur le Plateau et la Pointe de Beauregard. Accessible à tous, cette randonnée en raquettes offre des vues à couper le souffle sur les paysages environnants.', 'La randonnée en raquettes sur le Plateau et la Pointe de Beauregard offre de belles vues sur le Massif des Aravis et du Bargy et est accessible à tous.
...
La descente se fait en suivant le sentier fléché « Croix Fry », qui permet de rejoindre le tracé de l''aller pour retourner au parking.', 6900, 280, 1633, 1452, 2, 2, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/pZhT3ErwUl?iframe');
INSERT INTO public.trek VALUES (45, 'Le Tour des Fiz', 'En boucle', '13 heures et 20 minutes', 'Passy', '45.951173, 6.739291', 'https://www.visugpx.com/download.php?id=RHiMoNknKP', 'Partez à la découverte des Fiz lors de ce trek de 3 jours. Admirez des paysages magnifiques, des lacs alpins et des sommets majestueux tout en parcourant les sentiers de randonnée. Une expérience à ne pas manquer pour les amoureux de la nature et des sports de plein air.', 'Le tour des Fiz est une randonnée incontournable pour les amateurs de montagne et les amoureux de la nature. Ce trek de trois jours permet de découvrir les paysages alpins exceptionnels de la région de la Haute-Savoie. Voici un récapitulatif de cette randonnée de trois jours.
...
Le troisième jour est le dernier jour de la randonnée. Les randonneurs traversent le désert de Platé, avant de redescendre vers la station de Plaine-Joux pour clôturer le tour des Fiz. Cette randonnée est une expérience inoubliable pour les amateurs de nature, de montagne et de randonnée.', 51000, 3356, 2354, 1000, 6, 5, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/RHiMoNknKP?iframe');
INSERT INTO public.trek VALUES (46, 'Trail de Gets', 'En boucle', '5 heures et 20 minutes', 'Les Gets', '46.161948, 6.673159', 'https://www.visugpx.com/download.php?id=wkBbm8Obcy', 'Le Trail des Gets permet de se dépasser tout en découvrant les merveilles du terrain gétois : alpages, crêtes avec vue sur le Mont Blanc et le Roc d''Enfer, passages en sous-bois. Le trail se déroule sur le versant du Mont Chéry et autour du Roc d''Enfer, offrant un terrain montagneux technique et roulant.', 'Le trail des Gets est une épreuve incontournable pour les amateurs de course en montagne. Cette course de 36 kilomètres propose un parcours technique et exigeant, qui mettra à l''épreuve la résistance physique et mentale des coureurs.
...
Le parcours comprend également des passages en sous-bois, qui ajoutent un niveau de difficulté supplémentaire à la course. Les coureurs doivent être vigilants et concentrés pour éviter les obstacles et les surfaces glissantes.', 35670, 2089, 1880, 1056, 5, 5, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/wkBbm8Obcy?iframe');
INSERT INTO public.trek VALUES (47, 'Le Lac Bleu', 'Aller-retour', '2 heures', 'Morillon', '46.086818, 6.679317', 'https://www.visugpx.com/download.php?id=qyE9pSj7JP', 'Cette promenade est sans conteste la plus fréquentée de la vallée. Outre les lacs de Samoëns et de Morillon elle permet d’accéder aux très belles berges du Giffre, non loin de la passerelle de La R’Biolle.', 'Située dans la vallée de Giffre, la promenade du Lac Bleu est une destination idéale pour une journée en famille.
...
La passerelle de La R''Biolle et les bois de L''Etelley ajoutent une touche de charme supplémentaire à cette balade, qui est sans doute l''une des plus fréquentées de la vallée.', 7000, 36, 698, 668, 7, 1, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/qyE9pSj7JP?iframe');
INSERT INTO public.trek VALUES (48, 'Le Roc d''Enfer', 'En boucle', '6 heures et 20 minutes', 'Bellevaux', '46.242021, 6.526950', 'https://www.visugpx.com/download.php?id=qtYi8ZErjB', 'Cette randonnée de 33 km en Haute-Savoie offre des panoramas spectaculaires sur les montagnes environnantes, notamment depuis la Tête des Follys et la Haute Pointe. 

Préparez-vous pour une journée de défis et de paysages à couper le souffle !', 'La randonnée débute à "Jambaz de ça", situé dans la commune de Bellevaux en Haute-Savoie. Elle fait une boucle de 33 km avec un dénivelé de 2300 mètres. 
...
Cette randonnée offre une vue imprenable sur les montagnes environnantes et est accessible aux randonneurs expérimentés.', 33200, 2302, 2243, 963, 5, 5, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/qtYi8ZErjB?iframe');
INSERT INTO public.trek VALUES (49, 'Trail Coupardine', 'En boucle', '4 heures et 50 minutes', 'Orange', '46.02124, 6.32368', 'https://www.visugpx.com/download.php?id=pRbs2ZxjPb', 'Coupardine est un trail qui vous emmènera au cœur des montagnes du massif des Bornes et des Glières, avec un panorama à vous couper le souffle. 

Une vue à 360° depuis les sommets de Sur Cou, La Roche Parnal et Sous Dine, d’où vous pourrez admirer la vallée de l’Arve (du lac Léman jusqu’au Mont Blanc) en passant également par le massif du Bargy et la chaîne des Aravis.', 'Le trail Coupardine est une aventure mémorable qui offre des sentiers variés et des vues spectaculaires sur les montagnes environnantes. Il est recommandé d''être en bonne condition physique et de bien se préparer avant de partir à l''aventure. La prudence est également de mise lors de la randonnée. Alors, chaussez vos chaussures de trail et venez explorer cette merveille de la Haute-Savoie !
...
Enfin, la majestueuse montagne Sous Dine vous offrira des sentiers variés à travers des forêts verdoyantes et des crêtes escarpées. Vous pourrez découvrir une vue panoramique à 360 degrés sur les massifs environnants, avec notamment le Mont Blanc en toile de fond.', 24960, 1879, 1996, 1032, 3, 5, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/pRbs2ZxjPb?iframe');
INSERT INTO public.trek VALUES (50, 'Tour des Fiz (à la journée)', 'En boucle', '10 heures', 'Passy', '45.9499, 6.75307', 'https://www.visugpx.com/download.php?id=6l7bs9v0mz', 'Ce trail offre une expérience inoubliable avec des vues panoramiques spectaculaires tout au long du parcours. C''est un défi difficile mais gratifiant pour ceux qui cherchent à explorer les montagnes de Haute-Savoie.', 'La randonnée au départ de Plaine Joux en Haute-Savoie est une aventure époustouflante avec des vues panoramiques à couper le souffle. Le parcours de 39 km et un dénivelé de 2900 m offre un défi difficile mais gratifiant pour les randonneurs expérimentés.
...
Le parcours se poursuit vers le Lac de Pormenaz puis par les chalets d''Ayères et le Lac Vert avant de revenir au point de départ.', 38700, 2920, 2345, 1217, 6, 5, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/6l7bs9v0mz?iframe');
INSERT INTO public.trek VALUES (51, 'Ultra Tour du Môle', 'En boucle', '8 heures et 30 minutes', 'Marignier', '46.091883, 6.500080', 'https://www.visugpx.com/download.php?id=E3P3snoAEw', 'L''UTM : « ultra tour du môle » est une course exigeante de 32 km pour un dénivelé positif de 3200 mètres, ce qui en fait un trail quasi unique en son genre.

Malgré ses caractéristiques, la variété sera au rendez vous : du bitume sur quelques kilomètres, du single à plat, de la piste forestière, une descente de 1400 mètres pour son final, ou du « dré dans l''pentu » !! Voilà qui devrait satisfaire les amateurs de trail complet.', 'Cette course de trail est connue pour son parcours exigeant, technique et très montagneux, offrant des vues magnifiques sur les montagnes environnantes.
...
Arrivée à la Croix, l''heure de la dernière descente de la course est arrivée avec le retour à Marignier.', 31360, 3113, 1847, 493, 5, 5, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/E3P3snoAEw?iframe');
INSERT INTO public.trek VALUES (52, 'Trail des Glières', 'En boucle', '10 heures et 50 minutes', 'Thorens Glières', '45.997178, 6.252834', 'https://www.visugpx.com/download.php?id=tY4dfYY6zi', 'Tu en as un peu assez du plat des trails urbain ? Avec cette course, tu auras la tête dans les nuages.', 'On commence par explorer la forêt domaniale de la Haute Filière, puis on grimpe à travers les lapiaz.
...
Sur le plateau calcaire des Glières, il y a même un peu d''histoire à découvrir en passant devant la monumentale sculpture rendant hommage à un mouvement résistant de la région pendant la guerre.', 41400, 2790, 1996, 657, 3, 5, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/tY4dfYY6zi?iframe');
INSERT INTO public.trek VALUES (53, 'Trail des Voirons', 'En boucle', '3 heures', 'Bonnes', '46.170961, 6.324607', 'https://www.visugpx.com/download.php?id=4nKrkcxMq1', 'Prêt à relever le défi du Trail des Voirons ? Ce parcours de 20km exigeant vous emmènera de Bonne jusqu''au sommet du Signal des Voirons. Mettez votre entraînement à l''épreuve et découvrez les paysages époustouflants de cette région lors de cette aventure inoubliable !', 'Le Trail des Voirons est une aventure épique de 20 km qui vous fera découvrir les merveilles de la région. Avec un dénivelé de 1250 mètres, cette boucle est une véritable épreuve pour les amateurs de trail. Au départ de la mairie de Bonne, direction la route de la grange de Boege. C''est ici que commence le véritable défi, avec la montée ardue jusqu''au Crêt des Fenils. Les jambes brûlent, le souffle se fait court, mais le paysage grandiose qui s''offre à vous en haut de la colline en vaut la peine.
...
La descente commence ensuite, avec le Col du Pralere et Notre-Dame du Pralere comme points de passage, avant de se poursuivre sur le chemin des Loies. La dernière ligne droite se dessine alors en ligne de mire. Les derniers kilomètres se font dans la douleur, mais la fierté de terminer cette boucle difficile est immense.', 20290, 1248, 1492, 524, 10, 5, '2023-04-01 11:11:53.341876+02', NULL, 'https://www.visugpx.com/4nKrkcxMq1?iframe');


--
-- Name: trek_id_seq; Type: SEQUENCE SET; Schema: public; Owner: lionel
--
...
--
-- Name: difficulty difficulty_pkey; Type: CONSTRAINT; Schema: public; Owner: lionel
--
...
--
-- Name: log_table log_table_pkey; Type: CONSTRAINT; Schema: public; Owner: lionel
--
...
--
-- Name: summit summit_pkey; Type: CONSTRAINT; Schema: public; Owner: lionel
--

ALTER TABLE ONLY public.summit
    ADD CONSTRAINT summit_pkey PRIMARY KEY (id);


--
-- Name: tag_has_trek tag_has_trek_pkey; Type: CONSTRAINT; Schema: public; Owner: lionel
--

ALTER TABLE ONLY public.tag_has_trek
    ADD CONSTRAINT tag_has_trek_pkey PRIMARY KEY (id);


--
-- Name: tag_has_trek tag_has_trek_tag_id_trek_id_key; Type: CONSTRAINT; Schema: public; Owner: lionel
--

ALTER TABLE ONLY public.tag_has_trek
    ADD CONSTRAINT tag_has_trek_tag_id_trek_id_key UNIQUE (tag_id, trek_id);


--
-- Name: tag tag_pkey; Type: CONSTRAINT; Schema: public; Owner: lionel
--
...
--
-- Name: trek trek_pkey; Type: CONSTRAINT; Schema: public; Owner: lionel
--

ALTER TABLE ONLY public.trek
    ADD CONSTRAINT trek_pkey PRIMARY KEY (id);


--
-- Name: tag_has_trek tag_has_trek_tag_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: lionel
--

ALTER TABLE ONLY public.tag_has_trek
    ADD CONSTRAINT tag_has_trek_tag_id_fkey FOREIGN KEY (tag_id) REFERENCES public.tag(id);


--
-- Name: tag_has_trek tag_has_trek_trek_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: lionel
--

ALTER TABLE ONLY public.tag_has_trek
    ADD CONSTRAINT tag_has_trek_trek_id_fkey FOREIGN KEY (trek_id) REFERENCES public.trek(id);


--
-- Name: trek trek_difficulty_id; Type: FK CONSTRAINT; Schema: public; Owner: lionel
--

ALTER TABLE ONLY public.trek
    ADD CONSTRAINT trek_difficulty_id FOREIGN KEY (difficulty_id) REFERENCES public.difficulty(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: trek trek_summit_id; Type: FK CONSTRAINT; Schema: public; Owner: lionel
--

ALTER TABLE ONLY public.trek
    ADD CONSTRAINT trek_summit_id FOREIGN KEY (summit_id) REFERENCES public.summit(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: TABLE difficulty; Type: ACL; Schema: public; Owner: lionel
--

GRANT ALL ON TABLE public.difficulty TO lionel;


--
-- Name: TABLE log_table; Type: ACL; Schema: public; Owner: lionel
--

GRANT ALL ON TABLE public.log_table TO lionel;


--
-- Name: TABLE summit; Type: ACL; Schema: public; Owner: lionel
--

GRANT ALL ON TABLE public.summit TO lionel;


--
-- Name: TABLE tag; Type: ACL; Schema: public; Owner: lionel
--

GRANT ALL ON TABLE public.tag TO lionel;


--
-- Name: TABLE tag_has_trek; Type: ACL; Schema: public; Owner: lionel
--

GRANT ALL ON TABLE public.tag_has_trek TO lionel;


--
-- Name: TABLE trek; Type: ACL; Schema: public; Owner: lionel
--

GRANT ALL ON TABLE public.trek TO lionel;
